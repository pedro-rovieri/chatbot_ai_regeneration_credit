...
Interface for the ResearcherPool contract, which handles token
...
Checks if a researcher is eligible to withdraw rewards for a given era.
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | bool | true if the researcher can withdraw, false otherwise. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| user | address | The address of the researcher withdrawing tokens. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| user | address | The address of the researcher. |
