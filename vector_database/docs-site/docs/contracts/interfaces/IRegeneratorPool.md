...
Interface for the RegeneratorPool contract, which handles token
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | bool | true if the regenerator can withdraw, false otherwise. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| user | address | The address of the regenerator withdrawing tokens. |
