...
Interface for the InspectorPool contract, which handles token
...
Checks if a inspector is eligible to withdraw rewards for a given era.
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | bool | true if the inspector can withdraw, false otherwise. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| user | address | The address of the inspector withdrawing tokens. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| user | address | The address of the inspector. |
