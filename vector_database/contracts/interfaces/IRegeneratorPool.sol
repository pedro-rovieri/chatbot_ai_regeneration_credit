...
/**
 * @title IRegeneratorPool
 * @notice Interface for the RegeneratorPool contract, which handles token
 * custody, distribution, and era-based logic for regenerators.
 */
interface IRegeneratorPool {
  /**
   * @notice Checks if a regenerator is eligible to withdraw rewards for a given era.
   * @param era The era number to check eligibility for.
   * @return true if the regenerator can withdraw, false otherwise.
   */
   ...
   * @param user The address of the regenerator withdrawing tokens.
