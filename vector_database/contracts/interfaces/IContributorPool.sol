...
/**
 * @title IContributorPool
 * @notice Interface for the ContributorPool contract, which handles token
 * custody, distribution, and era-based logic for contributors.
 */
interface IContributorPool {
  /**
   * @notice Checks if a contributor is eligible to withdraw rewards for a given era.
   * @param era The era number to check eligibility for.
   * @return true if the contributor can withdraw, false otherwise.
   */
   ...
   * @param user The address of the contributor withdrawing tokens.
