...
/**
 * @title IResearcherPool
 * @notice Interface for the ResearcherPool contract, which handles token
 * custody, distribution, and era-based logic for researchers.
 */
interface IResearcherPool {
  /**
   * @notice Checks if a researcher is eligible to withdraw rewards for a given era.
   * @param era The era number to check eligibility for.
   * @return true if the researcher can withdraw, false otherwise.
   */
   ...
   * @param user The address of the researcher withdrawing tokens.
